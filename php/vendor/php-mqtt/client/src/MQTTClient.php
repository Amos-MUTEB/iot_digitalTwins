...
class MQTTClient implements ClientContract
{
    ...
    public function __construct(
        string $host = '1nygvs.messaging.internetofthings.ibmcloud.com',
        int $port = 1883,
    ...
    public function connect(
        string $username = "a-1nygvs-avu0otj3wv",
        string $password = "sfT02PH1sJn0lsSZcL",
     ...
     * @throws ConnectingToBrokerFailedException
     */
    protected function performConnectionHandshake(string $username, string $password, bool $sendCleanSessionFlag = false): void
    {
        try {
            $i = 0;
            $buffer = '';
